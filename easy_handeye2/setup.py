...
setup(
 ...
 entry_points={
     'console_scripts': [
                ...
                'rqt_handeye_calibrator = easy_handeye2.handeye_rqt_calibrator_main:main',
                'rqt_handeye_evaluator = easy_handeye2.handeye_rqt_evaluator_main:main',
                'rqt_handeye_mover = easy_handeye2.handeye_rqt_mover_main:main',
     ],
   },
)
